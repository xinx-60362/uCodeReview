...
public abstract class AbstractLayout
  ...
  public void addLayoutComponent(Component comp, Object constraints) {
    ...
    newConstraints[this.myConstraints.length] = ((GridConstraints) ((GridConstraints) constraints)
        .clone());
  ...
  public final void removeLayoutComponent(Component comp) {
    ...
    if (this.myComponents.length == 1) {
      ...
      System
          .arraycopy(this.myComponents, i + 1, newComponents, i, this.myComponents.length - i - 1);
      this.myComponents = newComponents;
    }
    if (this.myConstraints.length == 1) {
      ...
      System.arraycopy(this.myConstraints, i + 1, newConstraints, i,
          this.myConstraints.length - i - 1);
      this.myConstraints = newConstraints;
    }
  }
